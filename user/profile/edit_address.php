...
<body>
            ...
            <div class="max-md:w-full md:w-3/4 bg-white p-4">
                ...
                <form method="POST" id="updateAddressForm" class="mb-4">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" id="address_line_1" name="address_line_1" required class="border border-gray-300 px-4 py-2 rounded max-xl:w-full w-3/4">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" id="address_line_2" name="address_line_2" class="border border-gray-300 px-4 py-2 rounded max-xl:w-full w-3/4">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" id="city" name="city" required class="border border-gray-300 px-4 py-2 rounded max-xl:w-full w-3/4">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" id="state" name="state" required class="border border-gray-300 px-4 py-2 rounded max-xl:w-full w-3/4">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" id="zip_code" name="zip_code" required class="border border-gray-300 px-4 py-2 rounded max-xl:w-full w-3/4">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" id="country" name="country" required class="border border-gray-300 px-4 py-2 rounded max-xl:w-full w-3/4">
                    ...
                    <button type="submit" id="updateAddressBtn" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">update</button>
                </form>
            </div>
    ...
    <script src="../../dist/js/user/edit_address.js"></script>
</body>
</html>