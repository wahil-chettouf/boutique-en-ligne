    ...
    <div class="app">
        ...
        <div class="container mx-auto flex max-md:flex-col max-md:items-center md:justify-between">
            ...
            <div class="max-md:w-full md:w-3/4 bg-white p-4">
                <h2 class="text-2xl font-bold mb-4">Modification de mote de passe</h2>
                <form id="passwordForm">
                    <input type="hidden" name="_method" value="PUT_PASSWORD">

                    <div class="mb-4">
                        <label for="password" class="block mb-2">Ancienne mot de passe</label>
                        <input type="password" id="old_password" name="old_password" required class="border border-gray-300 px-4 py-2 rounded max-xl:w-full w-3/4">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="password" id="password" name="password" required class="border border-gray-300 px-4 py-2 rounded max-xl:w-full w-3/4">
                        ...
                        <input type="password" id="confirm_pass" name="confirm_pass" required class="border border-gray-300 px-4 py-2 rounded max-xl:w-full w-3/4">
