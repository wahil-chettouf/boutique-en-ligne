                ...
                <section class="flex flex-col space-y-6 w-full xl:w-1/2">
                    ...
                    <form id="newProductForm" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="number" id="p_stock" name="p_stock" min="1" value="1" class="w-full px-3 py-2 border rounded-lg focus:outline-none focus:ring-blue-500 focus:border-blue-500" required>
